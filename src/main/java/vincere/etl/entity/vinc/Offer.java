...
public class Offer {
  ...
  @Column(name="reminder_mails")
  private String reminderMails;
  ...
  @Column(name="draft_offer")
  private long draftOffer;

  @Column(name="latest_update_date")
  private java.sql.Timestamp latestUpdateDate;
  ...
  @Column(name="temp_position_type")
  private long tempPositionType;
  ...
  public String getReminderMails() {
    return this.reminderMails;
  }

  public void setReminderMails(String reminderMails) {
  ...
  public long getDraftOffer() {
    return this.draftOffer;
  }

  public void setDraftOffer(long draftOffer) {
    this.draftOffer = draftOffer;
  }

  public java.sql.Timestamp getLatestUpdateDate() {
    return this.latestUpdateDate;
  }

  public void setLatestUpdateDate(java.sql.Timestamp latestUpdateDate) {
  ...
  public long getPlacementType() {
    return this.placementType;
  }

  public void setPlacementType(long placementType) {
  ...
  public long getTempPositionType() {
    return this.tempPositionType;
  }

  public void setTempPositionType(long tempPositionType) {
    this.tempPositionType = tempPositionType;
  }
