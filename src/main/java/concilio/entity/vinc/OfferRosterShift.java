...
@Entity
@Table(name="offer_roster_shift")
public class OfferRosterShift {
  ...
  @Column(name="offer_roster_id")
  private long offerRosterId;
  ...
  public long getOfferRosterId() {
    return this.offerRosterId;
  }

  public void setOfferRosterId(long offerRosterId) {
    this.offerRosterId = offerRosterId;
  }
